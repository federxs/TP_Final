...
namespace DAOs
{
    public static class DAO_Pedido
    {
        public static List<ProductoFiltrado> obtenerProductosPorFiltro(int? idTipoProducto, String nombre, float? precio, DateTime? fechaDesde, DateTime? fechaHasta)
        {
            ...
            cn.ConnectionString = cn.ConnectionString = DAOs.StringConexion.StringLucasBD;
            cn.Open();
        ...
        public static List<Pedido> obtenerPedidosCliente(int idCliente)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = cn;
            cmd.CommandText = @"SELECT TOP 1000 P.idPedido
                                ,P.fechaEntrega
                                ,P.idEstado
                                ,P.idCliente  
                                ,P.fechaGeneracion
            ...
            while (dr.Read())
            {
                ...
                p.fechaEntrega = (DateTime)dr["fechaEntrega"];
                p.fechaGeneracion = (DateTime)dr["fechaGeneracion"];
                p.idPedido = int.Parse(dr["idPedido"].ToString());
                Estado e = new Estado();
